...
<div class="container contact-us-page animated fadeIn">
	<div>
	    <h3 class="text-center title">Having some question? Feel free to get in touch.</h3>
	</div>
  <div class="row">
    ...
    <div class="col-sm-12 row"  id="parent">
    	...
    	<div class="col-sm-6" style="padding-left: 50px;">
    		<div>
		    <h3 class="text-left title m0 mb20" style="font-size: 14px;">Send us feedback.</h3>
		</div>
    		<form action="form.php" class="contact-form" method="post">
		      ...
		      <br>
	      	  <button class="btn btn-default btn-send"> <span class="glyphicon_contact glyphicon_contact-send"></span> Send </button>
		      </div>
     		</form>
    	</div>
    </div>
