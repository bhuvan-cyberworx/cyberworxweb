...
<div id="svg-letter">
 <svg viewBox="0 0 700 700" preserveAspectRatio="none" width="100%" height="100%" >
    <path id="one" class="letter active letter-x" stroke-width="" stroke="black" d="M260.9,330.5L74.7,49.1h174.1L352,220.7l100-171.6h173.2L441.5,333.7l208.2,317.2H475.7L345.5,437.8L221.9,650.9H50.3 L260.9,330.5z" >

   
    </path>
   <path id="two" class="letter letter-e" fill="black" stroke-width="" stroke="black" d="M378.38,50.5c126.81,0,205,62.54,247.55,134.63l-125.08,66c-23.45-38.22-67.75-68.62-122.47-68.62-94.68,0-161.56,73-161.56,167.64S283.7,517.8,378.38,517.8c45.17,0,86-15.64,109.44-34.74V434.42H354.93V310.21H634.62v226.7c-62.54,68.62-146.79,112.92-256.24,112.92-172.85,0-313.56-115.52-313.56-299.66S205.53,50.5,378.38,50.5Z" ></path>

  <path id="three" class="letter active letter-x" stroke-width="" stroke="black" d="M260.9,330.5L74.7,49.1h174.1L352,220.7l100-171.6h173.2L441.5,333.7l208.2,317.2H475.7L345.5,437.8L221.9,650.9H50.3 L260.9,330.5z" >

  <path id="four" class="letter letter-e" fill="black" stroke-width="" stroke="black" d="M130.12,50.07h440.1v130.5H284.92v99.9h279v131.4h-279v108h285.3v130.5H130.12Z" data-reactid=".0.$/.3.2.1.2.0.0" ></path>
  </svg>
</div>
...
<script type="text/javascript">
  ...
  // let svgLetter = document.getElementById("svg-letter");

  // console.log('#'+letter[currentID].id);
  // console.log('#'+letter[nextID].id);
  //   setTimeout(function() {
  //     console.log(`#${letter[currentID].id}`, `#${letter[nextID].id}`)

  //     var tween = KUTE.to( `#${letter[currentID].id}`  , { path: `#${letter[nextID].id}` }, {
  //     duration: 900,
  //     morphPrecision: 4,
  //     morphIndex: 4,
  //     yoyo: true,
  ...
  //   });
  //     setTimeout(function(){
  //       document.getElementById(letter[preiousvID].id).style.display = "none";
  //     },1000);
    

  //   document.getElementById(letter[nextID].id).style.display = "block";
  //   tween.start();
  //   preiousvID = currentID;
  //   currentID = nextID;
  // }, 200);
